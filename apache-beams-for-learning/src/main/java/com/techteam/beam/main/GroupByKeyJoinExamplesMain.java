...
public class GroupByKeyJoinExamplesMain {
    ...
    private static void runGroupByKeyBigQuery() {
        ...
        //Inner Join
        PCollection<KV<Integer, String>> joinInnerCollection = productTypePCollection
        ...
        PCollection<KV<Integer, CoGbkResult>> groupResult = KeyedPCollectionTuple.of(productTag, joinInnerCollection)
                ...
                .apply(ParDo.of(new DoFn<KV<Integer, CoGbkResult>, String>() {
                    ...
                    public void process(ProcessContext c) {
                        ...
                        while(iterator.hasNext()) {
                            ...
                            row.append(String.join(",", products[0], products[1], products[2], productTypes[1]));
                            if (iterator.hasNext()) {
                                row.append("\n");
                            }
                        }
